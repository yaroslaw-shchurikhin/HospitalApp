...
{
	partial class DoctorConfirmedOrdersForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.Name = "DoctorConfirmedOrdersForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Подтверждённые приёмы";
